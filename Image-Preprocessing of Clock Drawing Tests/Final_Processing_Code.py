...
directory = r'/Users/adityaghai/Downloads/NHATS_R3_ClockDrawings'
os.chdir(directory)
...
for file_name in x:
    ...
    def part1():
        ...
        part1resultpath = r'/Users/adityaghai/Desktop/image processing clock/Processing_run_3/Part1_result'
        os.chdir(part1resultpath)
        cv2.imwrite(file_name, step1)
    
    def part2():
        file_name2 = r'/Users/adityaghai/Desktop/image processing clock/Processing_run_3/Part1_result/' + file_name
        print(file_name2)
        ...
        #########
        #Save the image
        part2resultpath = r'/Users/adityaghai/Desktop/image processing clock/Processing_run_3/Part2_result'
        os.chdir(part2resultpath)
        cv2.imwrite(file_name, step2)
    
    def part3():
        file_name3 = r'/Users/adityaghai/Desktop/image processing clock/Processing_run_3/Part2_result/' + file_name
        ...
        part3resultpath = r'/Users/adityaghai/Desktop/image processing clock/Processing_run_3/Part3_result'
